...
namespace CBAI.Web.Data.Migrations
{
    ...
    [Migration("20260805230950_AddMembershipApplicationConcurrency")]
    partial class AddMembershipApplicationConcurrency
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CBAI.Web.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("CBAI.Web.Membership.Member", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<DateOnly?>("ShareholderSince")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CBAI.Web.Membership.MembershipApplication", b =>
                {
                    ...
                    b.Property<string>("RequestedMembershipTypeName")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CBAI.Web.Membership.MembershipApplicationAuditEntry", b =>
                {
                    b.HasOne("CBAI.Web.Membership.MembershipApplication", null)
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CBAI.Web.Data.ApplicationUser", null)
                        .WithMany()
